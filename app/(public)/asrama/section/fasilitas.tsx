        ...
        <div className="mb-10 grid grid-cols-1 gap-6 md:mb-12 md:grid-cols-12 md:gap-10 sm:mb-12">
          ...
          <div className="md:col-span-9">
            <p className="text-sm leading-relaxed text-slate-600 sm:text-base">
              Asrama SMK TI BAZMA dilengkapi dengan berbagai fasilitas yang nyaman dan mendukung kehidupan sehari-hari siswa, mulai dari kamar tidur, ruang makan, musholla, hingga area olahraga dan ruang belajar malam.
            </p>
          </div>
        </div>
