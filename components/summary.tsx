...
const defaultPartnerLogos: Logo[] = [
  ...
  { src: "/images/logo-secondary.png", alt: "SMK TI BAZMA Secondary", width: 150, height: 48 },
  { src: "/images/logo.png", alt: "BAZMA Learning Ecosystem", width: 150, height: 48 },
  { src: "/images/logo-secondary.png", alt: "BAZMA Boarding School", width: 150, height: 48 },
]
      ...
      <div className="mx-auto w-full max-w-[1920px] px-6 py-16 sm:px-10 sm:py-20 lg:px-16 xl:px-24">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[180px_1fr] lg:gap-12">
          <div className="lg:pt-2">
            <p className="text-sm font-semibold leading-snug tracking-wide text-blue-950">
              {label}
            </p>
          </div>
          ...
          <div className="">
            <blockquote className="text-3xl font-medium leading-tight text-neutral-800 sm:text-4xl lg:text-[2.75rem]">
              <TextReveal
                textClassName="p-0 text-3xl font-medium leading-tight text-neutral-800 sm:text-4xl lg:text-[2.75rem]"
              >
                {quote}
              </TextReveal>
            </blockquote>
